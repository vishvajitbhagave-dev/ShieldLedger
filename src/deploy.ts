/**
 * Deploy the ShieldLedger contract to a Midnight network (undeployed by
...
// private state (SME/lender secrets + credit profile) is created once per
// network and persisted so reconnecting CLI runs keep identity.
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy ShieldLedger to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  console.log('  Compiled contract ready.');
