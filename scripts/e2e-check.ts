/**
 * End-to-end smoke check for ShieldLedger.
 *
...
import { loadOrCreatePrivateState } from '../src/private-state';
import { compiledShieldLedgerContract } from '../src/compiled';
...
async function main() {
  ...
  try {
    await findDeployedContract(providers, {
      ...
      initialPrivateState: loadOrCreatePrivateState(network),
    });
  } catch (err: any) {
